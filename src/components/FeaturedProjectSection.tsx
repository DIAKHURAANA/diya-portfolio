...
export const FeaturedProjectSection: React.FC<FeaturedProjectProps> = () => {
  ...
  const videoPath = '/videos/featured_clip_01.mp4';
    ...
    <section ref={sectionRef} className="relative min-h-screen w-full flex items-center justify-center bg-black overflow-hidden border-t border-white/10 select-none">
      ...
      >
        ...
        >
          ...
          <span>FLAGSHIP FEATURED MOTION SHOWCASE</span>
        </motion.div>
        ...
        <div className="overflow-hidden">
          ...
          >
            FEATURED COMMERCIAL & MOTION REEL
          </motion.h2>
        </div>
        ...
        >
          A flagship commercial motion reel showcasing high-impact brand strategy, motion typography, visual editing, and social conversion creative.
        </motion.p>
        ...
        >
          <Magnet padding={80} strength={2.5}>
            ...
            >
              ...
              <span>WATCH FEATURED REEL (WITH AUDIO)</span>
            </button>
          </Magnet>
        </motion.div>
      </motion.div>
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-black/40">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-syne text-xs uppercase tracking-widest text-[#EAE0D5]">
                    FLAGSHIP FEATURED MOTION SHOWCASE
                  </span>
                </div>
              ...
              <div className="p-6 bg-black/60 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="font-syne text-xs text-[#EAE0D5]/70 max-w-xl mt-1">
                    Premium video commercial demonstrating strategic storytelling, brand aesthetic framing, and dynamic motion graphics.
                  </p>
                </div>
